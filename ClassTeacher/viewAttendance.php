       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Kehadiran Kelas</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Kehadiran Kelas</li>
            </ol>
          </div>
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Memilih takrikh<span class="text-danger ml-2">*</span></label>
                    ...
                    <button type="submit" name="view" class="btn btn-primary">Melihat Kehadiran Kelas</button>
                  </form>
                </div>
              </div>
